...
@DisplayName(value = "View 컨트롤러 테스트 - 댓글")
...
class ArticleCommentControllerTest {
    ...
    ArticleCommentControllerTest(@Autowired MockMvc mockMvc, @Autowired FormDataEncoder formDataEncoder) {
    ...
    void givenArticleCommentInfo_whenRequesting_thenSavesNewArticleComment() throws Exception {
        ...
        willDoNothing().given(articleCommentService).saveArticleComment(any(ArticleCommentDomainDto.class));
        ...
        then(articleCommentService).should().saveArticleComment(any(ArticleCommentDomainDto.class));
    }
