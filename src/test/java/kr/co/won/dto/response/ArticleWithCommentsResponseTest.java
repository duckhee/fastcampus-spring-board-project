...
class ArticleWithCommentsResponseTest {
    ...
    void givenArticleWithCommentsDtoWithoutChildComments_whenMapping_thenOrganizesCommentsWithCertainOrder() {
        ...
        Set<ArticleCommentDomainDto> articleCommentDtos = Set.of(
    ...
    private ArticleWithCommentsDto createArticleWithCommentsDto(Set<ArticleCommentDomainDto> articleCommentDtos) {
    ...
    private ArticleCommentDomainDto createArticleCommentDto(Long id, Long parentCommentId, LocalDateTime createdAt) {
