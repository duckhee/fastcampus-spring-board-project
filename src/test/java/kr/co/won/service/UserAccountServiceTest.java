...
class UserAccountServiceTest {
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserDomain userAccount = createUserAccount("uno");
        UserDomain savedUserAccount = createSigningUpUserAccount("uno");
    ...
    private UserDomain createUserAccount(String username) {
        return createUserAccount(username, null);
    }

    private UserDomain createSigningUpUserAccount(String username) {
        return createUserAccount(username, username);
    }

    private UserDomain createUserAccount(String username, String createdBy) {
